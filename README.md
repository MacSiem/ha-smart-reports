...
Smart Reports is a dashboard viewer. For emailed reports install the **HA Tools Email** integration plus the dedicated `ha-log-email` / `ha-energy-email` cards (separate HACS repositories).
